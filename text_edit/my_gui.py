...
file_menu.add_command(label="Print to PDF", command=lambda:prt_to_pdf(text, my_font))
...
menu_bar.add_command(label="Bold", command=lambda:make_bold(text))

#Add Itallic menu
italic_menu = Menu(menu_bar, tearoff=0)
menu_bar.add_command(label="Italic", command=lambda:make_italic(text))

#Add Underline menu
underline_menu = Menu(menu_bar, tearoff=0)
menu_bar.add_command(label="Underline", command=lambda:make_underline(text))
